...
@ObjCClassName("MetagunIOS")
public class MetagunIOS extends NSObject implements UIApplicationDelegate {
	...
	public boolean applicationDidFinishLaunchingWithOptions(
		...
		this.app = new IOSApplication(new Metagun(), config);
	...
	public static void main(String[] args) {
		UIKit.UIApplicationMain(0, null, null,
				MetagunIOS.class.getSimpleName());
	}
	...
	@Generated("NatJ")
	@Selector("alloc")
	public static native MetagunIOS alloc();

	@Generated("NatJ")
	protected MetagunIOS(Pointer peer) {
		super(peer);
	}
	
	@Selector("init")
	public MetagunIOS init() {
		super.init();
		return this;
	}
