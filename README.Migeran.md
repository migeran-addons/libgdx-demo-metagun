LibGDX Demo Metagun with Migeran Support
-----------------------------------------

This branch contains the Migeran backend for the Metagun LibGDX Demo.

NOTE: This backend is work in progress, known to have stability issues.
